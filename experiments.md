...
| 8 | 2026-02-11 | RSF多seed平均 (5seeds x 200trees, MEDIUM 36特征) | 0.9721 | 0.9410 | 0.0145 | pending | 对齐原始0.96624配置: n_estimators=200, 5个seed(42,123,456,789,2026)平均. CV不变(仍n=1000单seed). 总计1000棵树但多样性更高. 目标: 降低full retrain方差, 缩小CV-LB gap. |
