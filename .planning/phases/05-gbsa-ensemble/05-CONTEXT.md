...
- exp34+Exp22离线校准: 对submission_exp34_full.csv套A=1.0655,B=-0.0108,lam=6.0 (Codex预期LB 0.9668-0.9677)
- GBSA+RSF constrained weight search: w_GBSA∈[0.10,0.30], 目标mean(OOF)-λ*std(OOF), bootstrap检验稳定性
</specifics>
